...
$comando3="SELECT * FROM avisos WHERE idCurso='$idCurso'";
        ...
        <div id="board">
            ...
            <?php while($registro3 = mysqli_fetch_assoc($resultado3)) : 
              ...
              ?> 
               <div class="aulas">
                <h1>Aviso <?=$cont?></h1>
                <a href="deleteAviso.php?idAviso=<?=$registro3["idAviso"]?>"><img width="20" src="img/delete.png" alt="excluir"></a>
                </div>
                <?php endwhile ?>
            
            <a id="link" href="addAviso.php?idCurso=<?=$idCurso?>">
            <div id="addaula">
                <h1 id="textadd">Adicionar aviso</h1>
            </div>
            </a>
