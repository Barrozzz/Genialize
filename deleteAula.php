...
$idCurso = $registro3["idCurso"];

$comando = "DELETE FROM arquivos WHERE idAula = $idAula";

$resultado = mysqli_query($conexao, $comando);

$comando4 = "DELETE FROM aulas WHERE idAula = $idAula";
  ...
  <body>
    ...
    <div id="mae">
        <div>
            ...
            <a id="tentarnov" href="dashboard.php?idCurso=<?=$idCurso?>">Voltar</a>
        </div>
    </div>
