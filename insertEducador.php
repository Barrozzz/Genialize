...
$imagem = $_FILES["imgEducador"];

$de = $imagem["tmp_name"];
$para = "uploadEducador/" . $imagem["name"];

move_uploaded_file($de, $para);

$comando = "INSERT INTO educadores (nome, cpf, email, senha, contato, imgEducador) VALUES ('$nome', '$cpf', '$email', '$senha', '$contato', '$para')";

$resultado = mysqli_query($conexao, $comando);

$idEducador = mysqli_insert_id($conexao);
?>
...
<html lang="pt">
  ...
  <body>
    ...
    <div id="mae">
        <div>
            <p>Educador Cadastrado</p>
            <img id="erro" src="img/logo.png"><br>
            <a id="tentarnov" href="loginEducador.php">Login</a>
        </div>
    </div>
