...
<body>
    ...
    <div id="fundo">
        ...
        <h1 id="titulo" ><?=$registro["titulo"]?></h1>
        ...
        <?php while($registro3 = mysqli_fetch_assoc($resultado3)) : 
            ...
            <div class="aulas">
                <h1> Arquivo <?=$cont?></h1>
                <div id="imgaula">
                  <a href="deleteArquivo.php?idArquivo=<?=$registro3["idArquivo"]?>"><img width="20" src="img/delete.png" alt="excluir"></a>
                </div>
              </div>
                <?php endwhile ?>
            <a id="link" href="configArquivo.php?idAula=<?=$idAula?>">
            <div id="addaula">
                <h1 id="textadd">Adicionar arquivo</h1>
              </div> 
            </a>
