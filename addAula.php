...
<html lang="pt">
  ...
  <body>
    ...
    <form action="insertAula.php?idCurso=<?=$idCurso?>" method="post">
      <div id="cont">
        <div id="contesq">
          <h1 id="titulo">Titulo da aula:</h1>
          <input id="titulotext" name="titulo" type="text" placeholder="Insira o título...">
          <br>
          <h1 id="titulo">Descrição da aula:</h1>
	    <textarea id="desc"placeholder="Insira a descrição..." name="descricao" rows="4" cols="50"></textarea>
        <br>
        <br>
            <button type="submit" class="botao" id="botaoSalvar">Continuar</button>
            </div>
            </div>
            </form>
    </div>
