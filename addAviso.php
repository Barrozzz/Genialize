...
<html lang="pt">
  ...
  <body>
    ...
    <form action="insertAviso.php?idCurso=<?=$idCurso?>" method="post">
      <div id="cont">
        <div id="contesq">
          <h1 id="titulo">Aviso:</h1>
	    <textarea id="desc"placeholder="Insira o aviso..." name="aviso" rows="4" cols="50"></textarea>
        <br>
        <br>
            <button type="submit" class="botao" id="botaoSalvar">Enviar</button>
            </div>
            </div>
            </form>
    </div>
