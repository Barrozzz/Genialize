...
$de = $imagem["tmp_name"];
$para = "uploadUsuario/" . $imagem["name"];

move_uploaded_file($de, $para);

$comando = "INSERT INTO usuarios (nome, cpf, email, senha, contato, imgUsuario) VALUES ('$nome', '$cpf', '$email', '$senha', '$contato', '$para')";
  ...
  <body>
    ...
    <div id="mae">
        <div>
            ...
            <a id="tentarnov" href="Login.php">Login</a>
        </div>
    </div>
