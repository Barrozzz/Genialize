...
$comando3="SELECT * FROM arquivos WHERE idArquivo='$idArquivo'";

$resultado3 = mysqli_query($conexao, $comando3);

$registro3 = mysqli_fetch_assoc($resultado3);

$idAula = $registro3["idAula"];

$comando = "DELETE FROM arquivos WHERE idArquivo = $idArquivo";
  ...
  <body>
    ...
    <div id="mae">
        <div>
            ...
            <a id="tentarnov" href="addArquivo.php?idAula=<?=$idAula?>">Voltar</a>
        </div>
    </div>
