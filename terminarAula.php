...
$comando = "INSERT INTO assistido (idAula, idUsuario, assistido) VALUES ('$idAula', '$id', 'S')";
...
$comando3 = "SELECT * FROM aulas WHERE idAula='$idAula'";
  ...
  <body>
    ...
    <div id="mae">
        <div>
            ...
            <a id="tentarnov" href="aulas.php?idCurso=<?=$registro3["idCurso"]?>">Continuar</a>
        </div>
    </div>
