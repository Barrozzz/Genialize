...
if($senhaAtual == $registro2["senha"] && $senhaNova = $senhaRep) {
    $comando = "UPDATE educadores SET senha = '$senhaRep' WHERE idEducador = '$id'";
      ...
      <body>
        ...
        <div id="mae">
            <div>
                ...
                <a id="tentarnov" href="perfilEduc.php?idEducador=<?=$id?>">Voltar</a>
            </div>
        </div>
      ...
      <body>
        ...
        <div id="mae">
            <div>
                <p>Algo deu errado</p>
                <img id="erro" src="img/logo.png"><br>
                <a id="tentarnov" href="senhaEduc.php?idEducador=<?=$id?>">Tentar Novamente</a>
            </div>
        </div>
