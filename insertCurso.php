...
$imagem = $_FILES["imgcurso"];

$de = $imagem["tmp_name"];
$para = "uploadCurso/" . $imagem["name"];

move_uploaded_file($de, $para);

$comando = "INSERT INTO cursos (titulo, descricao, idioma, valor, categoria, sobre, imgCurso, idEducador) VALUES ('$titulo', '$descricao', '$idioma', '$valor', '$categoria', ' ', '$para', '$id')";
  ...
  <body>
    ...
    <div id="mae">
        <div>
            ...
            <a id="tentarnov" href="perfilEduc.php">Continuar</a>
        </div>
    </div>
