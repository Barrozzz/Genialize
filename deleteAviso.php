...
$comando3="SELECT * FROM avisos WHERE idAviso='$idAviso'";
...
$comando = "DELETE FROM avisos WHERE idAviso=$idAviso";
  ...
  <body>
    ...
    <div id="mae">
        <div>
            ...
            <a id="tentarnov" href="avisos.php?idCurso=<?=$idCurso?>">Voltar</a>
        </div>
    </div>
