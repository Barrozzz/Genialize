...
if($senhaAtual == $registro2["senha"] && $senhaNova = $senhaRep) {
    $comando = "UPDATE usuarios SET senha = '$senhaRep' WHERE idUsuario = '$id'";
      ...
      <body>
        ...
        <header>
          ...
          <div id="logo">
            ...
            <a href="pagInicial"> <img  id="imglogo" width="210" src="img/GENIALIZE.png" alt="logo"> </a>
            </div>
          </div>
          
          <div class="categorias">
            <a class="header" href="pagInicial">Categorias</a> 
           ...
           <div class="itensHeader3">
            ...
            <div class="itensHeader">
                <a href="perfil.php?id=<?=$id?>"><img class="imgdir" id="perfil" src="<?=$registro2["imgUsuario"]?>" width="50px"></a>
            </div>
        </header>
        ...
        <div id="mae">
            <div>
                ...
                <a id="tentarnov" href="perfil.php?id=<?=$id?>">Voltar</a>
            </div>
        </div>
      ...
      <body>
        ...
        <div id="mae">
            <div>
                <p>Algo deu errado</p>
                <img id="erro" src="img/logo.png"><br>
                <a id="tentarnov" href="senha.php?id=<?=$id?>">Tentar Novamente</a>
            </div>
        </div>
