...
if (isset($acessar)) {
    ...
    $comando = "SELECT * FROM educadores WHERE cpf = '$cpf' AND senha = '$senha'";
    ...
    if ($registro>0){
      $_SESSION["educ"] = $registro["idEducador"];
      $id = $_SESSION["educ"];
      header ("Location: perfilEduc.php?idEducador=$id");
  } else{ ?>
    <!DOCTYPE html>
    <html lang="pt">
      ...
      <body>
        ...
        <div id="mae">
            <div>
                ...
                <a id="tentarnov" href="loginEducador.php">Tentar Novamente</a>
            </div>
        </div>
