    ...
    <header>
      ...
      <div class="categorias">
       ...
       <div class="itensHeader3">
         ...
         <div class="itensHeader">
            <a href="perfil.html"><img class="imgdir" id="perfil" src="img/perfil.jpg" width="50px"></a>
        </div>
    </header>

    <div id="mae">
        <div>
            <img id="erro" src="img/orange-error-icon-0.png">
            <p>Houve uma falha</p>
            <a id="tentarnov"href="#">Tentar novamente</a>
        </div>
    </div>
