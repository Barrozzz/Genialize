...
$comando = "INSERT INTO aulas (titulo, descricao, idCurso) VALUES ('$titulo', '$descricao', '$idCurso')";
  ...
  <body>
    ...
    <div id="mae">
        <div>
            ...
            <a id="tentarnov" href="addArquivo.php?idAula=<?=$idAula?>">Continuar</a>
        </div>
    </div>
