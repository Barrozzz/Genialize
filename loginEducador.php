...
<body>
    ...
    <div id="pag">
        <h3>Entre como educador</h3>
        <div id="areaLogin">
            <img src="img/telaLogin.png" alt="Login">
            <form action="logEducador.php" method="post">
                <div class="item">
                ...
                <button type="submit" name="acessar" value="acessar">ENTRAR</button>
                <div id="atalho">
                    <p>Não tem uma conta? <a href="cadEducador.php">Cadastre-se</a></p>
                </div>
            </form>
        </div>        
    </div>
