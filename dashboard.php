...
$comando = "SELECT * FROM aulas WHERE idCurso='$idCurso'";;
    ...
    <div id="fundo">
        ...
        <div id="board">
            ...
            <?php while($registro3 = mysqli_fetch_assoc($resultado3)) : 
              ...
              <h1> Aula <?=$cont?></h1>
                <div id="imgaula">
                    <a href="addArquivo.php?idAula=<?=$registro3["idAula"]?>"><img width="20" id="edit" src="img/edit.png" alt="editar"></a>
                    <a href="deleteAula.php?idAula=<?=$registro3["idAula"]?>"><img width="20" src="img/delete.png" alt="excluir"></a>
                </div>
                </div>
                <?php endwhile ?>
            
            <a id="link" href="addAula.php?idCurso=<?=$idCurso?>">
            <div id="addaula">
                <h1 id="textadd">Adicionar aula</h1>
            </div>
            </a>
